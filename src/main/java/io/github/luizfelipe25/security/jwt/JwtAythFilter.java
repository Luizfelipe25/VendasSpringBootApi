package io.github.luizfelipe25.security.jwt;
...
public class JwtAythFilter extends OncePerRequestFilter {

    private JwtService jwtService;
    private UsuarioServiceImp usuarioService;

    public JwtAythFilter(JwtService jwtService, UsuarioServiceImp usuarioService) {
